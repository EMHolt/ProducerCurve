 ...
 * Date: September 2024
 * Hour: 3rd AP CSA
 * Description: Tests the ConsumerCurve.
 */

public class ConsumerCurveTest extends ConsumerCurve { 
	
	/**
	 * creates the curve to be tested
	 */
	 public ConsumerCurveTest() {
	...
	public static void main(String[] args) {
		 ...
		 * prints the curve
		 */
		ConsumerCurveTest basicTester = new ConsumerCurveTest();
